...
console.log("Naam: " + firstName + ",", "Kleur ogen: " + eyeColor + ",", "Leeftijd: " + age + ",", "Beroep: " + profession + ",", "Schoenmaat: " + shoeSize + ",", "Partner: " + partner + ",", "Kinderen: " + numberOfChildren + ",");